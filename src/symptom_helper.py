...
# Load datasets
sym_des = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/symtoms_df.csv"))
precautions = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/precautions_df.csv"))
workout = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/workout_df.csv"))
description = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/description.csv"))
medications = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/medications.csv"))
diets = pd.read_csv(os.path.join(BASE_DIR, "datasets_for_symptom_based_prediction_model/diets.csv"))

# Load model
svc = pickle.load(open(os.path.join(BASE_DIR, "model/svc.pkl"), "rb"))
